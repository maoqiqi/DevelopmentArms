...
public class MyFragment extends LazyLoadFragment {
    ...
    protected void loadData() {
        ...
        if (status == 0) {
            status = 1;
            tvName.setText(MainActivity.titles[position]);
            ...
            tvName.setText(String.format("%s,加载完成!", MainActivity.titles[position]));
    ...
    private static final class MyHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (weakReference.get() != null) {
                ...
                fragment.status = 3;
                fragment.tvName.setText(String.format("%s,加载完成!", MainActivity.titles[fragment.position]));
